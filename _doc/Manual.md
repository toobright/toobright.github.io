...
```yml
# Site settings
title: Matt Blog             # title of your website
SEOTitle: Matt Blog          # check out docs for more detail
...
sidebar-avatar: /img/avatar-Matt.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“Matt Blog”** but I want the title shows in search engine is **“黄玄的博客 | Matt Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/Mattpro/Mattpro.github.io/issues/15) about code wrap.
